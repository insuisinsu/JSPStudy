...
<body>
	...
	<center>
		<form name = "msgdel" method = "post" action = "freeboard_deldb.jsp">
			<!--  type="hidden" : HTML 페이지에 출력은 하지 않으나 변수의 값을 다른 페이지로 넘길 때 사용
				id 와 page 변수의 값을 처리 -->
			...
			<table width = "70%" cellspacing = "0" cellpadding = "2">
				...
				<b> 글 삭제하기 </b></td></tr>
				<tr><td colspan = "2" bgcolor = "#1f4f8f" height = "1" ></td></tr>
				<tr><td width="124" height="30" bgcolor = "#f4f4f4" align="center" class = "input_style1">
				비밀번호</td>
				...
				<tr><td colspan="2" align="right">
						<table width="100%" border="0" cellpadding="4" cellspacint="4">
							<tr><td width "84%"> &nbsp;</td>
								<td width = "8%">
